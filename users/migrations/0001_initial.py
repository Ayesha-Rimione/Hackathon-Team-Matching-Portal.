# Generated by Django 4.2.7 on 2025-08-23 15:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('programming', 'Programming'), ('design', 'Design'), ('business', 'Business'), ('marketing', 'Marketing'), ('data', 'Data Science'), ('other', 'Other')], max_length=50)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('looking_for_team', 'Looking for Team'), ('looking_for_members', 'Looking for Members'), ('not_looking', 'Not Looking')], default='not_looking', max_length=20)),
